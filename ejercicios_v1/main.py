...
def archivos(opcion):
	...
	match opcion:
		...
		case 3:
			...
			os.system("python ejercicios_v1/ejer3.py")
		#Si la opcion es 5
		case 5:
			#Se limpia la pantalla
			os.system ("clear")
			#Se abre el archivo ejer5.py
			os.system("python ejercicios_v1/ejer5.py")
		#Si la opcion es 8
		case 8:
			#Se limpia la pantalla
			os.system ("clear")
			#Se abre el archivo ejer8.py
			os.system("python ejercicios_v1/ejer8.py")
		#Si la opcion es 11
		case 11:
			#Se limpia la pantalla
			os.system ("clear")
			#Se abre el archivo ejer11.py
			os.system("python ejercicios_v1/ejer11.py")
		#Si la opcion es 14
		case 14:
			#Se limpia la pantalla
			os.system ("clear")
			#Se abre el archivo ejer14.py
			os.system("python ejercicios_v1/ejer14.py")
		#Si la opcion es 15
		case 15:
			#Se limpia la pantalla
			os.system ("clear")
			#Se abre el archivo ejer15.py
			os.system("python ejercicios_v1/ejer15.py")
		#Si la opcion es 16
		case 16:
			#Se limpia la pantalla
			os.system ("clear")
			#Se abre el archivo ejer16.py
			os.system("python ejercicios_v1/ejer16.py")
		#Si la opcion es 18
		case 18:
			#Se limpia la pantalla
			os.system ("clear")
			#Se abre el archivo ejer18.py
			os.system("python ejercicios_v1/ejer18.py")
		#Si la opcion es 19
		case 19:
			#Se limpia la pantalla
			os.system ("clear")
			#Se abre el archivo ejer19.py
			os.system("python ejercicios_v1/ejer19.py")
		#Si la opcion es 22
		case 22:
			#Se limpia la pantalla
			os.system ("clear")
			#Se abre el archivo ejer22.py
			os.system("python ejercicios_v1/ejer22.py")
